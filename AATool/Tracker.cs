...
namespace AATool
{
    public static class Tracker
    {
        ...
        public static readonly Dictionary<string, int> advancement_ids = new Dictionary<string, int> {
            ...
            { "Diamonds!", 34 },
            { "Enchanter", 35 },
            { "The Parrots and the Bats", 36 },
            { "Best Friends Forever", 37 },
            { "What a Deal!", 38 },
            { "Zombie Doctor", 39 },
            { "Not Today, Thank You", 40 },
            { "Bullseye", 41 },
            { "A Seedy Place", 42 },
            { "Fishy Business", 43 },
            { "Hired Help", 44 },
            { "Sniper Duel", 45 },
            { "Country Lode, Take Me Home", 46 },
            { "Hidden in the Depths", 47 },
            { "Subspace Bubble", 48 },
            { "Uneasy Alliance", 49 },
            { "This Boat Has Legs", 50 },
            { "Spooky Scary Skeleton", 51 },
            { "Two Birds, One Arrow", 52 },
            { "Sweet Dreams", 53 },
            { "Tactical Fishing", 54 },
            { "Arbalistic", 55 },
