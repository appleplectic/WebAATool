...
namespace AATool
{
    public static class Tracker
    {
        ...
        public static readonly Dictionary<string, int> advancement_ids = new Dictionary<string, int> {
            ...
            { "War Pigs", 11 },
            { "Oh Shiny", 12 },
            { "Ice Bucket Challenge", 13 },
            { "Who's Cutting Onions?", 14 },
            { "Suit Up", 15 },
            { "Not Quite \"Nine\" Lives", 16 },
            { "A Terrible Fortress", 17 },
            { "Adventure", 18 },
            { "Monster Hunter", 19 },
            { "Into Fire", 20 },
            { "Return to Sender", 21 },
            ...
            { "Tactical Fishing", 36 },
            { "Arbalistic", 37 },
            { "The Parrots and the Bats", 38 },
            { "Best Friends Forever", 39 },
            { "What a Deal!", 40 },
            { "Zombie Doctor", 41 },
            { "Not Today, Thank You", 42 },
            { "Bullseye", 43 },
            { "A Seedy Place", 44 },
            { "Fishy Business", 45 },
            { "Hired Help", 46 },
            { "Sniper Duel", 47 },
            { "Country Lode, Take Me Home", 48 },
            { "Hidden in the Depths", 49 },
            { "Subspace Bubble", 50 },
            { "Uneasy Alliance", 51 },
            { "Spooky Scary Skeleton", 52 },
            { "This Boat Has Legs", 53 },
            { "Two Birds, One Arrow", 54 },
            { "Sweet Dreams", 55 },
            { "A Throwaway Joke", 56 },
            { "Very Very Frightening", 57 },
            { "Total Beelocation", 58 },
            { "Cover Me in Debris", 59 },
            { "Serious Dedication", 60 },
            { "Bee Our Guest", 61 },
            { "Local Brewery", 62 },
            { "Withering Heights", 63 },
            { "Bring Home the Beacon", 64 },
            { "Beaconator", 65 },
            { "Who's the Pillager Now?", 66 },
            { "Voluntary Exile", 67 },
            { "Hero of the Village", 68 },
            { "A Furious Cocktail", 69 },
            { "How Did We Get Here?", 70 },
            { "The End... Again...", 71 },
            { "Sticky Situation", 72 },
            { "You Need a Mint", 73 },
            { "Postmortal", 74 },
